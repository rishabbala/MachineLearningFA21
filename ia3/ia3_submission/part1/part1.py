...
w = np.sort(w)
w_hat = np.sort(w_hat)
np.savetxt(f"Part1_w,w_hat.txt", [w.squeeze(1), w_hat.squeeze(1)])
np.savetxt(f"Part1_best.txt", [np.amax(training_accuracy_online), np.argmax(training_accuracy_online), np.amax(dev_accuracy_online), np.argmax(dev_accuracy_online), np.amax(training_accuracy_avg), np.argmax(training_accuracy_avg), np.amax(dev_accuracy_avg), np.argmax(dev_accuracy_avg)])
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title(f"Online_perceptron")
plt.legend(["Train Accuracy", "Dev Accuracy"])
plt.pause(1)
plt.savefig(f"Online_perceptron.png")
plt.cla()
plt.clf()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title(f"Average_perceptron")
plt.legend(["Train Accuracy", "Dev Accuracy"])
plt.pause(1)
plt.savefig(f"Average_perceptron.png")
plt.cla()
plt.clf()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title(f"Perceptron Accuracies")
